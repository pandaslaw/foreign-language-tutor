...
class FrequentWords:
    ...
    def _load_frequent_words(self, category: str) -> List[Dict]:
        ...
        basic_words = {
            ...
            'verbs': [
                {'word': 'gelmek', 'translation': 'to come', 'example': 'Yarın geliyorum.'},
                {'word': 'gitmek', 'translation': 'to go', 'example': 'Okula gidiyorum.'},
                # Add more words...
            ],
            'adjectives': [
                {'word': 'güzel', 'translation': 'beautiful', 'example': 'Çok güzel bir gün.'},
    ...
    def get_review_words(self, user_id: int, category: str, count: int = 3) -> List[Dict]:
