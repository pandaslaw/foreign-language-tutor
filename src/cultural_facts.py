    ...
    def __init__(self):
        ...
        self.islamic_traditions = [
            {
                ...
                'vocabulary': {'iftar': 'evening meal during Ramadan', 'hurma': 'date (fruit)'}
            },
            {
        ...
        self.daily_customs = [
            ...
            },
            {
                ...
                'vocabulary': {'Türk kahvesi': 'Turkish coffee', 'lokum': 'Turkish delight'}
            }
        ]
